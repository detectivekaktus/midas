...
def get_profile_menu_keyboard() -> ReplyKeyboardMarkup:
    return _get_menu_with_back_button(ProfileMenuOption)  # type: ignore


def get_transactions_menu_keyboard() -> ReplyKeyboardMarkup:
    return _get_menu_with_back_button(TransactionsMenuOption)  # type: ignore
