#!/usr/bin/env python3
from sqlalchemy import DOUBLE_PRECISION, ForeignKey, String
...
class Goal(Base):
    ...
    def __repr__(self) -> str:
        return f"Goal({self.id=!r}, {self.user_id=!r}, {self.title=!r}, {self.title=!r}, {self.description=!r}, {self.current_amount=!r}, {self.total_amount=!r})"
