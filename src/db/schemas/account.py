...
class Account(Base):
    ...
    debit_amount: Mapped[float] = mapped_column(DOUBLE_PRECISION, default=0, nullable=False)
    credit_amount: Mapped[float] = mapped_column(DOUBLE_PRECISION, default=0, nullable=False)
